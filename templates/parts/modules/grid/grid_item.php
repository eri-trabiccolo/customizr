  ...
  <section class="grid__item">
    <div class="tc-grid-figure entry-media__holder <?php czr_fn_echo( 'figure_class' ) ?>">
      <div class="entry-media__wrapper czr__r-i">
        <a class="bg-link" href="<?php the_permalink() ?>" title="<?php the_title_attribute( array( 'before' => __('Permalink to ', 'customizr') ) ) ?>" rel="bookmark"><span class="sr-only"><?php czr_fn_echo( 'title' ) ?></span></a>
      ...
      <div class="tc-grid-caption">
          <div class="entry-summary <?php czr_fn_echo('entry_summary_class') ?>">
            ...
            <h2 class="entry-title over-thumb">
              <a class="czr-title" href="<?php the_permalink() ?>" title="<?php the_title_attribute( array( 'before' => __('Permalink to ', 'customizr') ) ) ?>" rel="bookmark"><?php czr_fn_echo( 'title' ) ?></a>
            </h2>
            <?php
